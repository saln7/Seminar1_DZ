...
// if (firstNumber>secondNumber) // Первое число > Второе число
// {
//     if (firstNumber > thirdNumber) // Первое число > третье число
//     {
...
// else if (secondNumber > thirdNumber) // Второе число > третье число
// {
